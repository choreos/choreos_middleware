...
The  ``choreos-verao" is the organization name configured on the Chef Server. \Leo{essa parte tá meio ruizinha... alguém ajuda?}
...
To checkout the code: \texttt{svn checkout svn://svn.forge.objectweb.org/svnroot/choreos cloud}. \Leo{isso na verdade baixa todo o repositório; alguém sabe a forma certa?}
