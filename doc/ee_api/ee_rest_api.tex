...
The Listing~\ref{lst:chor_spec_example_java} shows an example of how to use the Java API to create a choreography specification. This example is quite equivalent to the XML in Listing~\ref{lst:chor_spec_xml}.
