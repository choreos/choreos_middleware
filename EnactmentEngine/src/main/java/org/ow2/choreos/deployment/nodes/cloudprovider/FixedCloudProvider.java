...
public class FixedCloudProvider implements CloudProvider {
	...
	String[] ips = cloudConfiguration.getMultiple("FIXED_VM_IPS");
	String[] hosts = cloudConfiguration.getMultiple("FIXED_VM_HOSTNAMES");
	String[] users = cloudConfiguration.getMultiple("FIXED_VM_USERS");
	String[] keys = cloudConfiguration.getMultiple("FIXED_VM_PRIVATE_SSH_KEYS");
	String[] types = cloudConfiguration.getMultiple("FIXED_VM_TYPES");
