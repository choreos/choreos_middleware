 ...
 * 
 * A sequence of invocations is a burst 
 * if N invocation are performed within a time DELTA.
 * After a burst, the counter starts again.
 * If the previous invocation was a long time ago (more than DELTA)
 * the counter is reseted too.
 * 
 * @author leonardo
 *
 */
