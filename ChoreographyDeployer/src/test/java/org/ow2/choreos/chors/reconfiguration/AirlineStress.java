...
public class AirlineStress {
    ...
    // private static DeploymentManagerServer deploymentServer;
    // private static ChorDeployerServer server;
    // private static ThresholdEvalDaemonService monitoring;
	...
	// deploymentServer = new DeploymentManagerServer();
	// deploymentServer.start();

	// server = new ChorDeployerServer();
	// server.start();

	// monitoring = new ThresholdEvalDaemonService();
	// monitoring.start();
