 ...
 * 
 * Before the test, start two DeploymentManager servers:
 * one in the port 9100 and the other in the port 9101
 * 
 * @author leonardo
 * 
 */
...
public class TwoCloudsEnactmentTest extends SimpleChorEnactmentTest {
	...
	public void setUp() {
		...
		ChoreographyServiceSpec airlineSpec = 
				super.chorSpec.getChoreographyServiceSpecByName(ModelsForTest.AIRLINE);
		ChoreographyServiceSpec travelSpec = 
				super.chorSpec.getChoreographyServiceSpecByName(ModelsForTest.TRAVEL_AGENCY);
