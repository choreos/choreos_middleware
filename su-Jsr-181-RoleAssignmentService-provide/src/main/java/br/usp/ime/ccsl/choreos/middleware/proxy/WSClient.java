...
public class WSClient {
     ...
     * 
     * @param wsdl
     *            the path or URL to the WSDL document
     * @throws XmlException
     * @throws IOException
    ...
    public WSClient(String wsdl) throws XmlException, IOException,
	    FrameworkException, WSDLException {
    ...
    /**
     * Retrieves the operations available in the service, using the SoapUI
     * library
     */
    ...
    public String request(String operationName, String... parameters)
	    throws InvalidOperationName, FrameworkException {
