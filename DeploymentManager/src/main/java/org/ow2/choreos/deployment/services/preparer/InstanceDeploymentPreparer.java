...
public class InstanceDeploymentPreparer {
	...
	PrepareDeploymentCommand prepareDeploymentCommand = PrepareDeploymentCommandFactory
		.getInstance(deploymentRequest);
	String command = prepareDeploymentCommand.getCommand();
