...
version           "1.0.0"
recipe            "mysql_$uuid", "Includes the client recipe to configure a client"
recipe            "mysql_$uuid::client", "Installs packages required for mysql clients using run_action magic"
recipe            "mysql_$uuid::server", "Installs packages required for mysql servers w/o manual intervention"
recipe            "mysql_$uuid::server_ec2", "Performs EC2-specific mountpoint manipulation"
