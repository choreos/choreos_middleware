...
@WebServiceClient(name = "HelloWorld8081Service", 
                  ...
                  targetNamespace = "http://webservice.support.proxy.middleware.choreos.ccsl.ime.usp.br/") 
public class HelloWorld8081Service extends Service {
    ...
    public final static QName HelloWorld8081Port = new QName("http://webservice.support.proxy.middleware.choreos.ccsl.ime.usp.br/", "HelloWorld8081Port");
    static {
        URL url = null;
        try {
